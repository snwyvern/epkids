...
[.width200]
image::docu/images/enumerations/Deleting_Enumeration.png[]
...
An other way without creating _Enumerations_ is to write the few contens on field level in the input field "Search (list). This allows also to select them, and to query for them.
