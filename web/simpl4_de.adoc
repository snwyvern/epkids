...
<simpl-executefilter pagesize=10 offset=0 data="{{addressList}}" 
		params="{{params}}" namespace="firstapp" ename="contact.filter"></simpl-executefilter> <!--2--> 
...
<div>
  ...
  <simpl-executefilter pagesize=10 offset=0 meta="{{meta}}" data="{{contactList}}" params=.{{params2}}" name="contact.filter"></simpl-executefilter>
