...
However, the web application can also be completely built according to your needs.
--
...
--
[CI, header="Comfortable connecting web applications with business processes"]
--
* starting processes
