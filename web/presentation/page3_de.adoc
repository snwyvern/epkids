...
* Freigeschaltete und als RPC-Type konfigurierte link:http://camel.apache.org[Camelrouten,window="_blank"] werden am link:https://github.com/tavendo/WAMP/blob/master/spec/basic.md[WAMP,window="_blank"]-Händler als Prozeduren registriert.
