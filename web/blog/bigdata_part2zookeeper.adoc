...
<2> In the *start* method, zookeeper is initiated. *start* is part of the BundleActivator interface
<2> In the *stop* method, zookeeper is terminated. *stop* is part of the BundleActivator interface
