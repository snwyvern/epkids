...
No resources should be fetched by maven at runtime. +
...
Objective: link:https://flink.apache.org[Apache Flink, window="_blank"] should be available as a Karaf feature.
...
<1> This is our flink feature, it comes from the local maven repositiory, see above.
