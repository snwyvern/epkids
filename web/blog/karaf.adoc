...
Except java 1.8, nothing is needed, everything is included.
...
Luckily, link:http://doc.akka.io/docs/akka/2.4.4/additional/osgi.html[Akka, window="_blank"] provides a framework for this purpose that we will use as a basis.
