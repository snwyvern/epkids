...
This command does all the necessary things.
...
----
<1> The creation of this artifact is described below.
<2> exclude the osgi core and the osgi compendium bundle
...
==== Now we create the flink service
...
Luckily, akka provides a link:http://doc.akka.io/docs/akka/2.4.4/additional/osgi.html[framework, window="_blank"]
...
Scala and akka have been removed and are integrated as stand-alone osgi bundes into the feature.
